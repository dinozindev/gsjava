...
public class GerenciadorUsuario {
    ...
    public void adicionarPontosUsuario(Usuario usuario, int pontos) {
    	if (usuarioLogado == null) {
    		System.out.println("O usuário informado não está logado.");
    	} else {
    		int pontosAtuais = usuario.getPontosUsuario();
        	usuario.setPontosUsuario(pontosAtuais+=pontos);
